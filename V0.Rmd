...
Funcion de densidad respecto a los días de los mes mas comunes de todos los años en el que se han visto ovnis en EEUU.
...
hist(dia, freq = FALSE, main = "Histograma y densidad",
     ylab = "Densidad")
...
para ello vemos que aproximadamente se avistaron estos ovnis en 2012.
```{r}
...
La distribución exponencial es la distribución de probabilidad del tiempo o espacio entre dos eventos en un proceso de Poisson, donde los eventos ocurren de manera continua e independiente a una tasa constante.

Ya sacamos la tasa de llegada de los ovnis en 2012 con la distribucion de Poisson , y con ello, podemos dibujar la gráfica de la función de densidad exponencial.
...
```
De la mimsa forma tenemos la funcion de distribucion de exponencial acumulada
...
#Funcion de la distribucion acumulada de Poisson
...
Gráfico de la función de distribución de Poisson

```{r}
plot(ppois(0:200, landa), type = "s", lwd = 2,
     main = "Función de distribución",
     xlab = "Número de eventos", ylab = "F(x)")

```

También podemos obtener los cuantiles correspondientes de la distribucion de Poisson

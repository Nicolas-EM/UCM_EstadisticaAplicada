...
```{r}
library(eulerr)
probinter1 <- datos_us[which(datos_us$city == 'seattle'&format(datos_us$datetime,"%H")==21),]
...
print(paste("Ver un UFO en seattle a las 21:00 es del",(sum(probinter2$x)/avistTot)*100,"%"))
print(paste("Ver un UFO en seattle o verlo a las 21:00 es del",(sum(probinter4$x)/avistTot)*100,"%"))
print(paste("Ver un UFO en una ciudad que no sea seattle a una hora distinta a las 21:00 es del",(sum(probinter6$x)/avistTot)*100,"%"))
print(paste("Ver un UFO en una ciudad que no sea seattle a las 21:00 es del",(sum(probinter8$x)/avistTot)*100,"%"))
print(paste("Ver un UFO en una ciudad distinta de seattle a las 21:00 con una forma que sea lumínica o desconocida",(sum(probinter10$x)/avistTot)*100,"%"))
print(paste("Ver un UFO en seattle a una hora distinta de las 21:00 con una forma que sea distinta de lumínica o desconocida pero con una duracion de mas de 10 segundos",(sum(probinter12$x)/avistTot)*100,"%"))

...
mostseek<-by_city[which(by_city$x>5),]
...
ggplot(mostseek, aes(x=mostseek$City, y=mostseek$x, fill=mostseek$City)) +
...
aux<-anios[which(anios$x == max(anios$x)),]
maxanio<-aux$Date
print(paste("El año con mayor probabilidad en caso de avistamiento fué:",maxanio,"con una probabilidad del",(aux$x/avistTot)*100,"%"))
